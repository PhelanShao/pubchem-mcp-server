...
exports.getPubchemData = getPubchemData;
...
async function getPubchemData(query, format = 'JSON', include3d = false) {
    ...
    if (fmt === 'XYZ') {
        if (include3d) {
            try {
                ...
                // 获取XYZ结构
                const xyzStructure = await (0, xyz_1.getXYZStructure)(data.CID, data.CanonicalSMILES, compoundInfo);
                if (xyzStructure) {
                    return xyzStructure;
                }
                else {
